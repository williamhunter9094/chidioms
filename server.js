...
var chidioms = [
  {id: 11, name: 'Horse Sweat'},
  {id: 12, name: 'Dead Rabbit'},
  {id: 13, name: 'Exemplar Teacher'},
  {id: 14, name: 'Eight Immortals'},
  {id: 15, name: 'Break Axe'},
  {id: 16, name: 'Garlic Skin'},
  {id: 17, name: 'Move Mountain'},
  {id: 18, name: 'Know Answer'},
  {id: 19, name: 'Break Bamboo'},
  {id: 20, name: 'Twin Endowment'},
];
